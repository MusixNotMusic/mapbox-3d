...
function MeshMaterial(options) {
  ...
  defineProperty(
    this,
    'translucent',
    defaultValue(options.translucent, false),
    onPropertyChanged
  )
  defineProperty(
    this,
    'wireframe',
    defaultValue(options.wireframe, false),
    onPropertyChanged
  )
  defineProperty(
    this,
    'side',
    defaultValue(options.side, MeshMaterial.Sides.DOUBLE),
    onPropertyChanged
  )
  ...
  defineProperty(
    this,
    'uniformStateUsed',
    defaultValue(options.uniformStateUsed, [
      {
  ...
  defineProperty(
    this,
    'vertexShader',
    defaultValue(options.vertexShader, this._vertexShader),
    onPropertyChanged
  )
  defineProperty(
    this,
    'fragmentShader',
    defaultValue(options.fragmentShader, this._fragmentShader),
    onPropertyChanged
  )

  this.cullFrustum = defaultValue(options.cullFrustum, false)
...
/**
 *
 * @memberof MeteoLib.Render.MeshMaterial
 * @property {Enum}FRONT
 * @property {Enum}BACK
