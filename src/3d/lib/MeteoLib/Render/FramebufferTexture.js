...
*需要配合{@link MeteoLib.Render.MeshVisualizer}、{@link MeteoLib.Render.Mesh}、{@link MeteoLib.Render.MeshMaterial}使用。
*@param {MeteoLib.Render.Mesh}mesh 
*
*@property {MeteoLib.Render.Mesh}mesh 
...
FramebufferTexture.prototype.destroy = function () {
  this.mesh = this.mesh && this.mesh.destroy()
  this.texture && this.texture.destroy()
  this.texture = undefined
  this._computeTexture && this._computeTexture.destroy()
  this._computeTexture = undefined
}
