...
*@example   
    ...
    CSG = MeteoLib.Util.CSG;  
    GeometryUtils = MeteoLib.Render.GeometryUtils; 
        //示例1:
        var cube = CSG.cube();
        var sphere = CSG.sphere({ radius: 1.3 });
        var polygons = cube.subtract(sphere).toPolygons();
 ...
 *@param {Array<MeteoLib.Util.CSG.Polygon>}
 *@param {Array<MeteoLib.Util.CSG>}
 */
...
CSG.prototype = {
  ...
  /**
   *
   *@return {Array<MeteoLib.Util.CSG.Polygon>}
   */
  toPolygons: function () {
 ...
 *       radius: 1
 *     });
 *@memberof MeteoLib.Util.CSG
 *@param {Object}options
 *@param {Array<Number>|MeteoLib.Util.CSG.Vector}[options.center=[0, 0, 0]]
 *@param {Number|Array<Number>|MeteoLib.Util.CSG.Vector}[options.radius=1]
 *@return {MeteoLib.Util.CSG}
 */
 ...
 *@memberof MeteoLib.Util.CSG
 *@param {Object}options
 *@param {Array<Number>|MeteoLib.Util.CSG.Vector}[options.start=[0, -1, 0]]
 *@param {Array<Number>|MeteoLib.Util.CSG.Vector}[options.end=[0, -1, 0]]
 *@param {Number}[options.radius=1]
 *@param {Number}[options.slices=16]
 *@return {MeteoLib.Util.CSG}
 */
 ...
 *@memberof MeteoLib.Util.CSG
 *
 *@param {Number|Array<Number>|MeteoLib.Util.CSG.Vector}xOrArrayXYZOrVec
 *@param {Number}[y]
 *@param {Number}[z]
 *
 *@property {Number}x
...
CSG.Vector.prototype = {
  /**
   *@return {MeteoLib.Util.CSG.Vector}
   */
  clone: function () {
  ...
  /**
   *@param {MeteoLib.Util.CSG.Vector}a
   *@return {MeteoLib.Util.CSG.Vector}
   */
  plus: function (a) {
 ...
 *
 *@memberof MeteoLib.Util.CSG
 *@param {Array<Number>|MeteoLib.Util.CSG.Vector}pos
 *@param {Array<Number>|MeteoLib.Util.CSG.Vector}normal
 *
 *@property {MeteoLib.Util.CSG.Vector}pos
 *@property {MeteoLib.Util.CSG.Vector}normal
 *
 *@constructor
 */
...
CSG.Vertex.prototype = {
  /**
   *@return {MeteoLib.Util.CSG.Vertex}
   */
  clone: function () {
   ...
   *
   *@param {MeteoLib.Util.CSG.Vertex}
   *@param {Number}
   *@return {MeteoLib.Util.CSG.Vertex}
   */
 ...
 *
 *@param {MeteoLib.Util.CSG.Vector}a
 *@param {MeteoLib.Util.CSG.Vector}b
 *@param {MeteoLib.Util.CSG.Vector}c
 */
...
CSG.Plane.prototype = {
  /**
   *@return {MeteoLib.Util.CSG.Plane}
   */
  clone: function () {
   ...
   *
   *@param {MeteoLib.Util.CSG.Polygon}polygon
   *@param {Array<MeteoLib.Util.CSG.Polygon>}coplanarFront
   *@param {Array<MeteoLib.Util.CSG.Polygon>}coplanarBack
   *@param {Array<MeteoLib.Util.CSG.Polygon>}front
   *@param {Array<MeteoLib.Util.CSG.Polygon>}back
   */
  splitPolygon: function (polygon, coplanarFront, coplanarBack, front, back) {
    ...
    for (var i = 0; i < polygon.vertices.length; i++) {
      ...
      var type =
        t < -CSG.Plane.EPSILON ? BACK : t > CSG.Plane.EPSILON ? FRONT : COPLANAR
      polygonType |= type
      types.push(type)
    }
 ...
 *
 *@memberof MeteoLib.Util.CSG
 *@param {Array<MeteoLib.Util.CSG.Vertex>}vertices
 *@param {Boolean}shared
 *
 *@property {Array<MeteoLib.Util.CSG.Vertex>}vertices
 *@property {Boolean}shared
 *@property {MeteoLib.Util.CSG.Plane}plane
 *@constructor
 */
CSG.Polygon = function (vertices, shared) {
  this.vertices = vertices
  this.shared = shared
  this.plane = CSG.Plane.fromPoints(
    vertices[0].pos,
    vertices[1].pos,
    vertices[2].pos
  )
...
CSG.Polygon.prototype = {
  /**
   *@return {MeteoLib.Util.CSG.Polygon}
   */
  clone: function () {
 ...
 *
 *@memberof MeteoLib.Util.CSG
 *@param {Array<MeteoLib.Util.CSG.Polygon>}polygons
 *
 *@property {Array<MeteoLib.Util.CSG.Polygon>}polygons
 *@property {MeteoLib.Util.CSG.Plane}plane
 *@property {MeteoLib.Util.CSG.Plane}front
 *@property {MeteoLib.Util.CSG.Plane}back
 *@constructor
 */
...
;(CSG.fromCSG = function (csg_model) {
   ...
   *@param {MeteoLib.Util.CSG.Vector}vertice_position
   *@param {MeteoLib.Util.CSG.Vector}plane_normal
   *@return {Number}
   *@private
   */
  (CSG.getGeometryVertice = function (
    positions,
    normals,
    vertice_position,
    plane_normal
